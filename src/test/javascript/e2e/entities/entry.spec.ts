...
describe('Entry e2e test', () => {
    ...
    it('should load Entries', () => {
        ...
        expect(entryComponentsPage.getTitle()).toMatch(/robblogApp.entry.home.title/);
    ...
    it('should load create Entry dialog', () => {
        ...
        expect(entryDialogPage.getModalTitle()).toMatch(/robblogApp.entry.home.createOrEditLabel/);
