...
describe('Blog e2e test', () => {
    ...
    it('should load Blogs', () => {
        ...
        expect(blogComponentsPage.getTitle()).toMatch(/robblogApp.blog.home.title/);
    ...
    it('should load create Blog dialog', () => {
        ...
        expect(blogDialogPage.getModalTitle()).toMatch(/robblogApp.blog.home.createOrEditLabel/);
